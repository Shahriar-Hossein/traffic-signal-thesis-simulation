...
def init_logger(duration_sec, uneven_mode=None):
    ...
    Example: data/logs/priority/120/priority_log_120_20250622_231230.csv
    """
    global log_filename
    ...
    log_dir = os.path.join(BASE_DATA_DIR, "logs", uneven_mode, duration_label)
...
def log_signal_change(green_direction):
    ...
    """
    global log_filename
    signal_log_dir = log_filename.replace(
        "logs", "log_signals"
        ).replace(".csv", "_signal.csv")
